...
in {
  ...
  home.file.".config/WebCord/Themes/DarkMatter.theme.css".source = "${dark-matter}/DarkMatter.theme.css";
  home.file.".config/WebCord/Themes/CatppuccinMocha.theme.css".source = "${catppuccin-mocha}/themes/mocha.theme.css";

  home.file.".config/WebCord/Themes/oxocarbondiscord.theme.css".text = ''
        /**
