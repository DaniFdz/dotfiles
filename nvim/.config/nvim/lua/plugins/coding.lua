return {
  "tpope/vim-sleuth", -- Automatically detects which indents should be used in the current buffer
  {
    ...
    opts = {
      provider = "claude",
      claude = {
        api_key_name = 'cmd:[ -n "$CLAUDE_API_KEY" ] && echo -n "$CLAUDE_API_KEY" || OP_ACCOUNT=my.1password.com op read "op://Private/CLAUDE_API_KEY/password" --no-newline',
      },
      hints = { enabled = false },
      mappings = {
        ask = "<leader>ca",
      ...
      local keys = {
        {
          ...
          function()
            ...
            vim.print("Added file to harpoon list")
          end,
        ...
        },
        {
          ...
          function()
            ...
            vim.print("Removed file from harpoon list")
          end,
      ...
      adapters = {
        ["neotest-golang"] = {
          go_test_args = {
            ...
            "10s",
            "-tags",
            "cli,postgres_testing,local_testing,runbook,e2e,dynamic",
          },
          dap_go_enabled = true,
        },
      },
